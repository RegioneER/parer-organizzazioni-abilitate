 ...
 *
 */
package it.eng.parer.org.abilitate.runner.filters;
...
import static it.eng.parer.org.abilitate.beans.utils.Costants.COD_PERM_INTERNAL;
...
public class PermissionAndAccessLogFilter {
	...
	if (ctx.getMethod().equals(HttpMethod.GET)
		&& ctx.getUriInfo().getPath().contains(URL_GET_ORGANIZATIONS)) {
