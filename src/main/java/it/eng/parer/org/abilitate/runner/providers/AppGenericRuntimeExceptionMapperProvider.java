 ...
 *
 */
package it.eng.parer.org.abilitate.runner.providers;
...
import it.eng.parer.org.abilitate.beans.utils.UUIDMdcLogUtil;
...
public class AppGenericRuntimeExceptionMapperProvider
	...
	return Response.status(500).entity(Map.of(COD_ERR_INTERNAL, MessageFormat.format(
		"Errore in fase di recupero delle organizzazioni abilitate per utente ''{0}'', si prega di contattare l''assistenza tecnica fornendo il codice {1}",
