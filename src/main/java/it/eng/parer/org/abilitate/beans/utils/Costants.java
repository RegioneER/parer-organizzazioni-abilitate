...
package it.eng.parer.org.abilitate.beans.utils;
...
public class Costants {
    ...
    // nome servizio
    public static final String SERVICE_NAME = "OrganizzazioniAbilitateMach";
    // IDP log accessi
    ...
    public static final String RESOURCE_ORGANIZATIONS = "/organizzazioni";

    //
    public static final String URL_GET_ORGANIZATIONS = URL_API_BASE + RESOURCE_ORGANIZATIONS;
